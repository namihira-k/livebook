...
class EventsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('events')->insert([
            ...
            [
                'id' => 45,
                'name' => '【日程未定】アラフェス 2020 at 国立競技場',
                'performer' => '嵐',
                'prefecture' => 'オンライン配信',
                'place' => 'オンライン配信',
                'hashtag' => '#アラフェス #嵐 #ARASHI',
                'from_date_time' => '2021-03-31 18:00:00',
                'to_date_time' => '2021-03-31 20:00:00',
                'url' => 'https://www.johnnys-net.jp/page?id=artistTop&artist=10',
