...
class EventsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('events')->insert([
            [
                'id' => 74,
                'name' => 'レディー・ガガ THE CHROMATICA BALL',
                'performer' => 'レディー・ガガ',
                'prefecture' => '埼玉',
                'place' => '西武ドーム',
                'hashtag' => '#レディー・ガガ #LADYGAGA',
                'from_date_time' => '2022-09-03 18:30:00',
                'to_date_time' => '2022-09-04 21:00:00',
                'url' => 'https://ladygaga.livenation.co.jp',
                'uuid' => '9e1d4e4d-d221-4d9c-98a0-e646b1ab6998',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'id' => 73,
                'name' => 'King Gnu Live at TOKYO DOME',
                'performer' => 'King Gnu',
                'prefecture' => '東京',
                'place' => '東京ドーム',
                'hashtag' => '#KingGnu',
                'from_date_time' => '2022-11-19 18:30:00',
                'to_date_time' => '2022-11-20 21:00:00',
                'url' => 'https://www.red-hot.ne.jp/sp/kinggnu_dome/',
                'uuid' => 'c9dc41c7-1c34-4c0a-9cec-3602cc1db00b',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                ...
                'performer' => 'ジャスティン・ビーバー',
                'prefecture' => 'ワールドツアー',
                'place' => 'ワールドツアー',
                'hashtag' => '#ジャスティンビーバー #JustinBieber',
                'from_date_time' => '2022-11-09 18:30:00',
                'to_date_time' => '2022-11-17 21:00:00',
                'url' => 'https://justinbieberjapantour.com',
                'uuid' => 'f62e9303-7335-4aca-acf7-f8ba8a685d9c',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                ...
                'prefecture' => '全国ツアー',
                'place' => '全国ツアー',
                'hashtag' => '#乃木坂46 #真夏の全国ツアー2022',
                'from_date_time' => '2022-07-19 18:00:00',
                'to_date_time' => '2022-08-31 21:00:00',
                'url' => 'https://www.nogizaka46.com/s/n46/',
                'uuid' => '178221f5-8e15-4396-b2ea-caf39b92eb58',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'id' => 70,
                'name' => 'Johnnys Festival　～Thank you 2021 Hello 2022～',
                'performer' => 'Johnnys',
                'prefecture' => '東京',
                'place' => '東京ドーム',
                'hashtag' => '#ジャニフェス #johnnysfestival',
                'from_date_time' => '2021-12-30 18:30:00',
                'to_date_time' => '2021-12-30 21:00:00',
                'url' => 'https://johnnys-festival.com',
                'uuid' => 'f8ca51a2-b632-4eec-a22f-facb6810a419',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'id' => 69,
                'name' => '乃木坂46 10th YEAR BIRTHDAY LIVE',
                'performer' => '乃木坂46',
                'prefecture' => '神奈川',
                'place' => '日産スタジアム',
                'hashtag' => '#乃木坂46 #バスラ #10thバスラ',
                'from_date_time' => '2022-05-14 18:00:00',
                'to_date_time' => '2022-05-15 21:00:00',
                'url' => 'https://www.nogizaka46.com',
                'uuid' => 'f8ca51a2-b632-4eec-a22f-facb6810a418',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'id' => 68,
                'name' => '乃木坂46 生田絵梨花 卒業コンサート',
                'performer' => '乃木坂46',
                'prefecture' => '神奈川',
                'place' => '横浜アリーナ',
                'hashtag' => '#乃木坂46 #生田絵梨花',
                'from_date_time' => '2021-12-14 18:00:00',
                'to_date_time' => '2021-12-15 21:00:00',
                'url' => 'https://www.nogizaka46.com',
                'uuid' => '050f7902-312b-4d64-ae31-5eb9fb82b06d',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
